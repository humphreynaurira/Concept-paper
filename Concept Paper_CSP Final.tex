...
\bibitem{}{Roscoe, A.W (1997).The Theory and Practice of Concurrency.{\em Prentice Hall ISBN 0-13-674409-5}}
\bibitem{}{INMOS(1995-05-12) Occam 2.1 Reference Manual(PDF) {\em SGS-THOMSON Microelectronics Ltd .,INMOS document  72 occ 45 03}}
\bibitem{}{“Resources about Threaded programming in the Bell Labs CSP style”{\em Retrieved 2010-04-15}}
\bibitem{}{“Language Design FAQ:{\em{ Why build concurrency on the ideas of CSP?”}}
\bibitem{}{Hoare, C.A.R. (1978).”Communicating Sequential Processes”. {\em Communications of the ACM 21(8):666-677.doi:10.1145/359576.359585.}}
\bibitem{}{	{ \em Brookes, Stephen; Hoare, C.A.R; Roscoe, A.W. (1984).}”A theory of Communicating Sequential Processes”.Jouranal of ACM.31(3):560-599.doi:10.1145/828.833}}
\end{thebibliography}
